...
```{r,echo=FALSE,out.width="100%",fig.cap="https://www.youtube.com/wO5NCcUoDi4"}
knitr::include_url("https://www.youtube.com/embed/wO5NCcUoDi4")
```
...
#### The ppt presentation as standalone material
...
## Special case of a presentation of results shown to farmers

```{r,echo=FALSE,out.width="100%",fig.cap="https://www.youtube.com/4n8kITEY8wQ"}
knitr::include_url("https://www.youtube.com/embed/4n8kITEY8wQ")
```
