...
```{r,echo=FALSE,out.width="100%",fig.cap="https://www.youtube.com/V-o9QbJQzTQ"}
knitr::include_url("https://www.youtube.com/embed/V-o9QbJQzTQ")
```
...
-----------------------   ----------------------------------------
![](img/Green dot.png)    We understand observations and they match expectations. All credible data match theory.
![](img/Red dot.png)      We observe something that is unexplained and unexpected. At least some credible data doesn’t match the dominant theory.
-----------------------   ----------------------------------------
...
3       ![](img/Green dot.png) ![](img/Red dot.png)   We thought we understood but have seen something new which upsets current theory
