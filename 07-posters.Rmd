...
```{r,echo=FALSE,out.width="100%",fig.cap="https://www.youtube.com/v6H2jlgGoGM"}
knitr::include_url("https://www.youtube.com/embed/v6H2jlgGoGM")
...
knitr::include_graphics("img/trad example 1.png")
```
...
```{r, echo = FALSE, fig.align='center',out.height="25%", out.width="50%"}
