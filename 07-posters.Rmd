...
```{r,echo=FALSE,out.width="100%",fig.cap="https://youtu.be/zc_GnRclgYQ"}
knitr::include_url("https://www.youtube.com/embed/zc_GnRclgYQ")
...
```{r, echo = FALSE, fig.align='center',out.height="50%", out.width="75%"}
